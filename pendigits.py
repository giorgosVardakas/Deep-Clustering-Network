...
from datasets.datasets import get_Pendigits_dataloader
import pdb
...
if __name__ == '__main__':
	...
	# Dataset parameters
	parser.add_argument('--input-dim', type=int, default=16, help='input dimension')
	...
	# Load data
	train_loader, datashape = get_Pendigits_dataloader(args.batch_size)
