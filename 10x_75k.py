...
from datasets.datasets import get_10x_73k_dataloader
import pdb
...
if __name__ == '__main__':
	...
	# Dataset parameters
	parser.add_argument('--input-dim', type=int, default=720, help='input dimension')
	...
	parser.add_argument('--n-clusters', type=int, default=8, help='number of clusters in the latent space')
	...
	# Load data
	train_loader, datashape = get_10x_73k_dataloader(args.batch_size, data_points=70000)
