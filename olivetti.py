...
from datasets.datasets import get_olivetti_faces_dataloader
...
if __name__ == '__main__':
	...
	parser.add_argument('--pre-epoch', type=int, default=1500, help='number of pre-train epochs')
	...
	parser.add_argument('--hidden-dims', default=[500, 500, 1000], help='learning rate (default: 1e-4)')
	parser.add_argument('--latent-dim', type=int, default=10, help='latent space dimension')
	parser.add_argument('--n-clusters', type=int, default=40, help='number of clusters in the latent space')
	...
	# Load data
	train_loader, datashape = get_olivetti_faces_dataloader(args.batch_size)
