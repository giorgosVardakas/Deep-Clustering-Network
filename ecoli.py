...
from datasets.datasets import get_ecoil_dataloader
...
if __name__ == '__main__':
	...
	parser.add_argument('--batch-size', type=int, default=84, help='input batch size for training')
	...
	parser.add_argument('--hidden-dims', default=[14], help='learning rate (default: 1e-4)')
	...
	# Load data
	train_loader, datashape = get_ecoil_dataloader(args.batch_size)
