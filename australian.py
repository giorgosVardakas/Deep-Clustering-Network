...
from datasets.datasets import get_australian_dataloader
...
if __name__ == '__main__':
	...
	# Dataset parameters
	parser.add_argument('--input-dim', type=int, default=14, help='input dimension')

	# Training parameters
	parser.add_argument('--lr', type=float, default=0.002, help='learning rate (default: 1e-4)')
	parser.add_argument('--wd', type=float, default=5e-4, help='weight decay (default: 5e-4)')
	parser.add_argument('--batch-size', type=int, default=69, help='input batch size for training')
	parser.add_argument('--epoch', type=int, default=50, help='number of epochs to train')
	parser.add_argument('--pre-epoch', type=int, default=500, help='number of pre-train epochs')
	...
	parser.add_argument('--hidden-dims', default=[10], help='learning rate (default: 1e-4)')
	parser.add_argument('--latent-dim', type=int, default=5, help='latent space dimension')
	parser.add_argument('--n-clusters', type=int, default=2, help='number of clusters in the latent space')
	...
	# Load data
	train_loader, datashape = get_australian_dataloader(args.batch_size)
