...
if __name__ == '__main__':
    ...
    # Dataset parameters
    parser.add_argument('--dir', default='./datasets/MNIST', help='dataset directory')
    ...
    # Main body
    model = DCN(args)    
    rec_loss_list, acc_list, nmi_list, ari_list = solver(args, model, train_loader, test_loader)
