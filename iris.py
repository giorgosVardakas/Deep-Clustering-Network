...
from datasets.datasets import get_iris_dataloader
...
if __name__ == '__main__':
	...
	parser.add_argument('--batch-size', type=int, default=50, help='input batch size for training')
	...
	# Load data
	train_loader, datashape = get_iris_dataloader(args.batch_size)
