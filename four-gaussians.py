...
if __name__ == '__main__':
	...
	parser.add_argument('--latent-dim', type=int, default=1, help='latent space dimension')
	parser.add_argument('--n-clusters', type=int, default=4, help='number of clusters in the latent space')
	...
	# Load data
	train_loader, datashape = get_four_guassian_dataloader(args.batch_size)
